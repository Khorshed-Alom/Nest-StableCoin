...
contract HelperConfig is Script {
    ...
    function getSepoliaEthConfig() public pure returns(NetworkConfig memory sepoliaEthConfig) {
        sepoliaEthConfig = NetworkConfig({
            ...
            weth: 0xdd13E55209Fd76AfE204dBda4007C227904f0a81, // sepolia Dummy / from patrick
            wbtc: 0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063, // sepolia Dummy / from patrick
            deployerKey: 0x00 //vm.envUint("PRIVATE_KEY")
        });
